...
use blog::handlers::post_handler::{get_featured_posts, get_post_by_slug, get_posts};
use dotenvy::dotenv;
...
use shared_lib::{
    database::client::connect_db, utils::cors::cors, AppErrorResponse, RequestPayload,
};
